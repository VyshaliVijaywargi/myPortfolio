          ...
          return (
            <div className="prj-flx-inner-cont" key={index}>
              ...
              <div className="prj-flx-inner-btn-cont">
                 <a className="btn prj-btn" target="_blank" href="https://web.whatsapp.com/">CODE</a>
                 <a className="btn btn-light prj-btn" target="_blank" href="https://web.whatsapp.com/">DEMO</a>
              </div>
            </div>
          );
        })}
