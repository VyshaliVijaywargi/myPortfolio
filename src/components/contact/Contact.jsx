    ...
    <div id="contact" className="cnt-main-cont">
      ...
      <div className="cnt-main-inner-cont">
        ...
        <div className="cnt-main-inner-flx-cont cnt-right-inner">
          <a href="tel:+91 9550722157" target="_blank">
            <FiPhoneCall />
            <div>+91 9550722157</div>
          </a>
          <a href="mailto:vyshali4794@gmail.com" target="_blank">
            <MdEmail />
            <div>vyshali4794@gmail.com</div>
          </a>{" "}
          ...
          <a
            href="www.linkedin.com/in/vyshali-vijaywargi-4709a6190"
            target="_blank"
          >
            <FaLinkedin />
            <div>LinkedIn</div>
